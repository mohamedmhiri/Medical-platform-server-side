...
$(document).ready(function () {
    ...
    // }else
    //     $('#calendar').fullCalendar('option', 'defaultView','agendaWeek');
    ...
    var options = { // Create an options object
        ...
        eventDrop: function (event) {
            ...
            if (response) {
                ...
                $('#calendar').fullCalendar('refetchEvents', {
                    ...
                    color: '#82052F',   // a non-ajax option
                    textColor: 'black' // a non-ajax option
                });
            }
        },
        ...
        eventSources: [
            ...
            },
            {
                ...
                color: '#51C1F0',   // a non-ajax option
                textColor: 'black', // a non-ajax option
                success: function (data) {
                    title: data.person_id;
                }
    ...
    function recreateFC(screenWidth,screenHeight) { // This will destroy and recreate the FC taking into account the screen size
    ...
    $(window).resize(function (e) { //set window resize listener
        recreateFC($(window).width(),$(window).height()); //or you can use $(document).width()
    });
    if( $( window).height()<600 && $(window).width()<400 ){
        recreateFC($(window).width(),$(window).height());
    }
